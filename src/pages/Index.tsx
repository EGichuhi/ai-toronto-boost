  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-500/10 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" />
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-primary/10 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000" />
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] bg-accent/10 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-2000" />
      </div>
      ...
      <div className="relative z-10">
        ...
        {/* Keep existing sections but update their background styles */}
        {/* Hero Section */}
        ...
        {/* Services Section */}
        <section id="services" className="py-20 px-4 relative backdrop-blur-sm">
